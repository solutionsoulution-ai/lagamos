  ...
  return (
    <div className="pb-20 bg-gray-50 min-h-screen overflow-x-hidden">
        ...
        <div className="absolute inset-0 pt-28 sm:pt-32 pb-12 sm:pb-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col">
            <div className="mb-auto">
              <button 
                onClick={onBack}
                className="inline-flex items-center gap-2 text-white bg-white/10 backdrop-blur-md border border-white/20 px-4 py-2 rounded-full hover:bg-white/20 transition-all group"
              >
                <ChevronLeft className="w-5 h-5 group-hover:-translate-x-1" />
                <span className="text-sm sm:text-base font-bold">{t.back}</span>
              </button>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-10 sm:-mt-24 relative z-10 space-y-16 sm:space-y-24">
          ...
          <div className="lg:col-span-2 space-y-8">
            <div className="bg-white rounded-[2.5rem] sm:rounded-[3rem] p-6 sm:p-12 shadow-2xl border border-gray-100 space-y-8">
              ...
              <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
                <div className="bg-emerald-50 p-6 sm:p-8 rounded-[2rem] border border-emerald-100 group hover:scale-[1.02] transition-transform shadow-sm">
                  <div className="flex justify-between items-start mb-4">
                    <p className="text-[10px] font-black text-emerald-600 uppercase tracking-widest">{t.labels.maxAmount}</p>
                ...
                <div className="bg-teal-50 p-6 sm:p-8 rounded-[2rem] border border-teal-100 group hover:scale-[1.02] transition-transform shadow-sm">
                  <div className="flex justify-between items-start mb-4">
                    <p className="text-[10px] font-black text-teal-600 uppercase tracking-widest">{t.labels.maxDuration}</p>
                    <PieChart className="w-6 h-6 text-teal-600" />
                  </div>
                  <p className="text-3xl sm:text-4xl font-black text-teal-950">{loan.maxDuration} {translations[language].calculator.months}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Footer CTA */}
        <div className="bg-gradient-to-br from-emerald-600 to-teal-900 rounded-[2.5rem] sm:rounded-[3.5rem] p-8 sm:p-14 text-center text-white space-y-6 relative overflow-hidden shadow-2xl">
           ...
           <div className="relative z-10 space-y-4 sm:space-y-6 max-w-3xl mx-auto">
              <h2 className="text-2xl sm:text-4xl font-black leading-tight">Votre projet mérite le meilleur taux.</h2>
              <p className="text-base sm:text-lg text-emerald-100 font-medium italic opacity-90">Simulation gratuite en 2 minutes. Réponse de principe immédiate.</p>
              <button 
                onClick={onApply}
                className="bg-white text-teal-950 px-8 py-3.5 rounded-xl font-black text-base sm:text-lg shadow-2xl hover:scale-105 active:scale-95 transition-all mt-4"
              >
