          ...
          <div className="p-8 sm:p-12">
            ...
            {isSubmitted ? (
              <div className="py-12 text-center space-y-8 animate-in zoom-in duration-500">
                <div className="bg-green-100 w-24 h-24 rounded-full flex items-center justify-center mx-auto text-green-600 shadow-lg shadow-green-100">
                  <CheckCircle className="w-12 h-12" />
                </div>
                <div className="space-y-2">
                  <h2 className="text-2xl font-black text-gray-900">{t.fields.success}</h2>
                  <p className="text-gray-500 font-medium">Un conseiller reviendra vers vous par email sous 24h.</p>
                </div>
                <button 
                  onClick={onBack}
