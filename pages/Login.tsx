...
import { Mail, Lock, LogIn, ChevronLeft, ArrowRight, HelpCircle, Eye, Loader2, ShieldCheck } from 'lucide-react';
...
const Login: React.FC<LoginProps> = ({ language, onLogin, onBack, onNavigate }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (cleanEmail === 'admin@europcapital.com' && cleanPass === 'admin123') {
        onLogin({ email: cleanEmail, role: 'admin', name: 'Administrateur' });
        return;
      }
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="bg-white p-8 sm:p-12 rounded-[2.5rem] shadow-2xl border border-gray-100 relative overflow-hidden">
          ...
          <div className="text-center space-y-4 mb-10">
            <div className="bg-emerald-50 w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-4"><ShieldCheck className="w-8 h-8 text-emerald-600" /></div>
